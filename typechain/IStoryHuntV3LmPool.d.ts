...
interface IStoryHuntV3LmPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IStoryHuntV3LmPool extends Contract {
  ...
  interface: IStoryHuntV3LmPoolInterface;
