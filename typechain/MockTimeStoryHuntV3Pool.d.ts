...
interface MockTimeStoryHuntV3PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeStoryHuntV3Pool extends Contract {
  ...
  interface: MockTimeStoryHuntV3PoolInterface;
