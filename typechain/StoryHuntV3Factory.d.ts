...
interface StoryHuntV3FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class StoryHuntV3Factory extends Contract {
  ...
  interface: StoryHuntV3FactoryInterface;
