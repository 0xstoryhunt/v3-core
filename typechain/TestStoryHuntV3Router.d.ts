...
interface TestStoryHuntV3RouterInterface extends ethers.utils.Interface {
  functions: {
...
export class TestStoryHuntV3Router extends Contract {
  ...
  interface: TestStoryHuntV3RouterInterface;
