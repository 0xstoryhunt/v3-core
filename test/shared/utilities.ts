...
export function createPoolFunctions({
  ...
  swapTarget: TestStoryHuntV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeStoryHuntV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestStoryHuntV3Router
  poolInput: MockTimeStoryHuntV3Pool
  poolOutput: MockTimeStoryHuntV3Pool
}): MultiPoolFunctions {
