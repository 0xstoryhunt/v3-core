...
import { StoryHuntV3PoolSwapTest } from '../typechain/StoryHuntV3PoolSwapTest'
...
describe('StoryHuntV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('StoryHuntV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as StoryHuntV3PoolSwapTest
          ...
          let tester: StoryHuntV3PoolSwapTest
