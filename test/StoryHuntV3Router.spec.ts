...
describe('StoryHuntV3Pool', () => {
  ...
  let pool0: MockTimeStoryHuntV3Pool
  let pool1: MockTimeStoryHuntV3Pool
  ...
  let swapTargetCallee: TestStoryHuntV3Callee
  let swapTargetRouter: TestStoryHuntV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeStoryHuntV3Pool, any]> => {
